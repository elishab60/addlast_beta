    ...
    if (!user) {
        return (
            <div className="text-center py-12">
                <div className="mb-6 font-semibold text-xl">Connecte-toi pour proposer une paire !</div>
                <Button asChild>
    ...
    if (cooldown) {
        return (
            <div className="text-center py-12">
                ...
                <div className="text-gray-600">Tu pourras proposer une nouvelle paire à partir du <b>{cooldown.toLocaleDateString()}</b>.</div>
            </div>
        );
    }

    return (
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-lg mx-auto my-10">
