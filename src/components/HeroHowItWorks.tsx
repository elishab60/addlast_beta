                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16 md:mb-20">
                    {/* Step 1: Vote */}
                      <div className="flex flex-col items-center text-center group animate-slide-up">
                          <div className="w-16 h-16 md:w-20 md:h-20 mb-6 flex items-center justify-center border-2 border-black rounded-full transition-all duration-500 group-hover:bg-accent group-hover:text-black group-hover:scale-110 group-hover:shadow-lg">
                            <CheckCircle
                                className="w-8 h-8 md:w-10 md:h-10 transition-transform duration-300 group-hover:rotate-12"
                                strokeWidth={1.5}
                            />
                        </div>
                          <h3 className="text-xl md:text-2xl font-bold mb-4 text-black text-balance transition-colors duration-300 group-hover:text-accent-muted">
                            Vote
                        </h3>
                    ...
                    {/* Step 2: Précommande */}
                      <div className="flex flex-col items-center text-center group animate-slide-up animation-delay-200">
                          ...
                          <p className="text-gray-600 text-base md:text-lg leading-relaxed max-w-xs transition-all duration-300 group-hover:text-gray-800">
                            Précommande quand la marque valide.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-center text-center group animate-slide-up animation-delay-400">
                        <div
                            className="w-16 h-16 md:w-20 md:h-20 mb-6 flex items-center justify-center border-2 border-black rounded-full transition-all duration-500 group-hover:bg-accent group-hover:text-black group-hover:scale-110 group-hover:shadow-lg">
                            <Shield
                                className="w-8 h-8 md:w-10 md:h-10 transition-transform duration-300 group-hover:rotate-12"
                                strokeWidth={1.5}
                            />
