    ...
    return (
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <main className="flex-1 container mx-auto px-6 py-12 max-w-3xl">
                <h1 className="text-3xl font-bold mb-4 text-black transition-colors hover:text-accent">Conditions Générales de Vente</h1>
                ...
                <div className="space-y-12 text-gray-800 leading-relaxed">
                    <section>
                        <h2 className="text-xl font-semibold border-l-4 border-accent text-black pl-4 mb-4">Préambule</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold border-l-4 border-accent text-black pl-4 mb-4">Produits et disponibilité</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold border-l-4 border-accent text-black pl-4 mb-4">Prix</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold border-l-4 border-accent text-black pl-4 mb-4">Commandes et paiement</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold border-l-4 border-accent text-black pl-4 mb-4">Livraison</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold border-l-4 border-accent text-black pl-4 mb-4">Droit de rétractation</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold border-l-4 border-accent text-black pl-4 mb-4">Garanties</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold border-l-4 border-accent text-black pl-4 mb-4">Service client</h2>
                        <p>
