        ...
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <main className="flex-1 container mx-auto px-6 py-12 max-w-3xl font-mono ">
                ...
                <div className="space-y-12 text-gray-800 leading-relaxed">
                    <section>
                        <h2 className="text-xl font-semibold border-l-4 border-accent text-black pl-4 mb-4">Éditeur</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold border-l-4 border-accent text-black pl-4 mb-4">Gérance</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold border-l-4 border-accent text-black pl-4 mb-4">Hébergeur</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold border-l-4 border-accent text-black pl-4 mb-4">RGPD</h2>
                        <p>
